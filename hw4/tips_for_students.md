...
This homework mainly depends on numpy and open3d. A `pyproject.toml` is provided — run `uv sync` to install all dependencies. If you encounter any issue, please let us know.
