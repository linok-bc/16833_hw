...
- If you are using Ubuntu and macOS, first install the `SuiteSparse` dependency as mentioned above. Then, install Python dependencies using `uv` (recommended): run `uv sync` in the `code/` directory.
